...
void __thiscall FUN_00423cf0(void *this,LPCWSTR param_1)

{
  ...
  if (param_1 == (LPCWSTR)0x0) {
    ...
    if ((local_11c == (char *)0x0) || (*local_11c == '\0')) {
      ...
      bVar9 = local_11c == *(char **)((int)this + 8);
      pcVar7 = local_11c;
      do {
        cVar2 = *pcVar7;
        pcVar7 = pcVar7 + 1;
      ...
      if (*(int *)((int)this + 0xc) + -1 < iVar8) {
        uVar6 = iVar8 + 0x50U & 0xffffffb0;
        ...
        if (pcVar7 == (char *)0x0) {
          ...
          *(uint *)((int)this + 0x10) = uVar6;
          if (bVar9) {
            FUN_00402480(pcVar7,iVar8 + 1,*(int *)((int)this + 8));
            pcVar7[iVar8] = '\0';
          }
          FUN_00423300(iVar1);
          *(uint *)((int)this + 0xc) = uVar6;
          *(char **)((int)this + 8) = pcVar7;
        }
      }
      if ((!bVar9) && (0 < iVar8)) {
        FUN_00402480(*(char **)((int)this + 8),iVar8 + 1,(int)pcVar3);
        *(undefined1 *)(iVar8 + *(int *)((int)this + 8)) = 0;
      }
    }
    local_8 = 0xffffffff;
