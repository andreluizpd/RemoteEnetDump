...
void __thiscall FUN_0040f510(void *this,LPCSTR param_1,UINT param_2)

{
  ...
  cbMultiByte = iVar1 + 1;
  FUN_004023f0((int *)this,cbMultiByte,(void *)((int)this + 4),0x104);
  ...
  if (bVar3) {
    ...
    if (DVar2 == 0x7a) {
      ...
      FUN_004023f0((int *)this,cchWideChar,(void *)((int)this + 4),0x104);
                    /* WARNING: Load size is inaccurate */
