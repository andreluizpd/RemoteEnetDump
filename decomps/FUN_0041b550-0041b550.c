...
void FUN_0041b550(int *param_1,LPCWSTR param_2,int param_3,undefined4 *param_4)

{
  ...
  _RTL_CRITICAL_SECTION local_a6c;
  ...
  puStack_c = &LAB_0044617d;
  local_10 = ExceptionList;
  uVar5 = DAT_00457600 ^ (uint)&stack0xfffffffc;
  ExceptionList = &local_10;
  local_a48 = param_1;
  local_a50 = param_2;
  local_a7c = ATL::CRegObject::vftable;
  local_a78 = 0;
  local_a74 = 0;
  local_a70 = 0;
  local_a4c = &local_a6c;
  local_a6c.DebugInfo = (PRTL_CRITICAL_SECTION_DEBUG)0x0;
  local_a6c.LockCount = 0;
  local_a6c.RecursionCount = 0;
  local_a6c.OwningThread = (HANDLE)0x0;
  local_a6c.LockSemaphore = (HANDLE)0x0;
  local_a6c.SpinCount = 0;
  local_a54 = 0;
  local_8 = 4;
  local_14 = uVar5;
  ...
  if (BVar6 == 0) {
    ...
    if (-1 < (int)DVar7) goto LAB_0041b631;
  }
  else {
LAB_0041b631:
    local_a54 = 1;
    if (param_4 != (undefined4 *)0x0) {
      ...
      while (pWVar2 != (LPCWSTR)0x0) {
        ...
        if ((pWVar2 != (LPCWSTR)0x0) && (iVar8 != 0)) {
          EnterCriticalSection(&local_a6c);
          local_a4c = (LPCRITICAL_SECTION)0x0;
          local_8._0_1_ = 5;
          FUN_00419ef0(pWVar2,iVar8);
          LeaveCriticalSection(&local_a6c);
    ...
    iVar8 = (**(code **)(*param_1 + 0x14))(&local_a7c,uVar5);
    pHVar3 = DAT_004597ec;
    if (-1 < iVar8) {
      local_a48 = (int *)0x0;
      local_8._0_1_ = 6;
      ...
      if (DVar7 == 0) {
        ...
        iVar8 = FUN_0041a0a0((int)&local_a7c,L"Module",(int)pWVar10);
        if ((-1 < iVar8) &&
           (iVar8 = FUN_0041a0a0((int)&local_a7c,L"Module_Raw",(int)local_a44), -1 < iVar8)) {
          if (param_3 == 0) {
            FUN_0041b4d0(&local_a7c,local_21c,local_a50,L"REGISTRY");
          }
          else {
            FUN_0041b3f0(&local_a7c,local_21c,local_a50,L"REGISTRY");
          }
        }
      }
      local_8 = CONCAT31(local_8._1_3_,4);
