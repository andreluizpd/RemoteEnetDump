...
byte * __cdecl FUN_00416560(byte *param_1,byte param_2)

{
  ...
  do {
    ...
    pbVar3 = param_1;
    while ((bVar2 & 4) == 0) {
      if (((&DAT_00449bf0)[pbVar3[1]] & 4) != 0) {
        pbVar3 = pbVar3 + 1;
        break;
      }
      if (((&DAT_00449bf0)[pbVar3[2]] & 4) != 0) {
        pbVar3 = pbVar3 + 2;
        break;
      }
      if (((&DAT_00449bf0)[pbVar3[3]] & 4) != 0) {
        pbVar3 = pbVar3 + 3;
        break;
      }
      pbVar1 = pbVar3 + 4;
