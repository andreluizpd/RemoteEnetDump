...
void __thiscall FUN_0040d8f0(void *this,char *param_1,ulong *param_2)

{
  ...
  local_14 = uVar2;
  if (((param_2 != (ulong *)0x0) && (*param_2 = 0, param_1 != (char *)0x0)) && (*param_1 != '\0')) {
    ...
    if (local_13d != '\0') {
      ...
      if (0 < *(int *)(local_130[0] + -0xc)) {
        local_144 = 0;
        cVar1 = FUN_0040b060(local_130[0],&local_144);
        if (cVar1 != '\0') {
          *param_2 = local_144;
        }
      }
