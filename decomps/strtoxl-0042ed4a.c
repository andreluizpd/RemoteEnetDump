...
LAB_0042edfb:
  ...
  else if (bVar8 == 0x2b) goto LAB_0042edfb;
  ...
  else if ((param_4 != 0x10) || (bVar8 != 0x30)) goto LAB_0042ee63;
  if ((*pbVar9 == 0x78) || (*pbVar9 == 0x58)) {
    bVar8 = pbVar9[1];
    pbVar9 = pbVar9 + 2;
  }
...
LAB_0042eec2:
    ...
    if ((uint)param_4 <= uVar6) goto LAB_0042eec2;
    if ((local_8 < uVar4) || ((local_8 == uVar4 && (uVar6 <= local_c)))) {
      ...
      param_5 = param_5 | 0xc;
      if (param_3 == (char **)0x0) goto LAB_0042eec2;
    }
    bVar8 = *pbVar9;
    pbVar9 = pbVar9 + 1;
  } while( true );
