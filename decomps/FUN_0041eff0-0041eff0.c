...
int __thiscall FUN_0041eff0(void *this,CSimpleStringT<char,0> *param_1)
      ...
      if (-1 < iVar2) {
        ...
        if (iVar2 <= *(int *)(iVar1 + -8)) {
          ...
          *(undefined1 *)(iVar2 + *(int *)param_1) = 0;
                    /* WARNING: Load size is inaccurate */
          iVar2 = (**(code **)(*this + 0x94))(iVar1,local_8);
          if (-1 < iVar2) {
          ...
          if (_Str != (char *)0x0) {
            ...
            if ((int)_Str < 0) goto LAB_0041f028;
          }
