...
void __thiscall FUN_0040e670(void *this,short *param_1,ulong *param_2)

{
  ...
  local_14 = uVar1;
  if (((param_2 != (ulong *)0x0) && (*param_2 = 0, param_1 != (short *)0x0)) && (*param_1 != 0)) {
    ...
    if (local_241 != '\0') {
      ...
      if (0 < *(int *)(local_234[0] + -6)) {
        local_248 = 0;
        uVar1 = FUN_0040b0a0(local_234[0],&local_248);
        if ((char)uVar1 != '\0') {
          *param_2 = local_248;
        }
      }
