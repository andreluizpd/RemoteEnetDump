...
undefined4 * __thiscall FUN_004032d0(void *this,int param_1)

{
  ...
  *(undefined2 *)(*(int *)((int)this + 8) + 0x10) = 0;
  local_8 = 0;
  FUN_00402d10((void *)((int)this + 0xc),*(void **)(param_1 + 0xc),
               *(rsize_t *)((int)*(void **)(param_1 + 0xc) + -0xc),(undefined4 *)this);
  *(undefined ***)this =
       ATL::
