...
int * __fastcall FUN_00414040(int *param_1)

{
  ...
  *param_1 = (int)ATL::
                  CFixedStringT<class_ATL::CStringT<wchar_t,class_ATL::StrTraitATL<wchar_t,class_ATL::ChTraitsCRT<wchar_t>_>_>,40>
                  ::vftable;
  ExceptionList = local_10;
  return param_1;
}
