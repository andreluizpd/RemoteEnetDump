...
void __thiscall
FUN_00404110(void *this,int param_1,wchar_t *param_2,char *param_3,int param_4,char *param_5,
            va_list param_6)

{
  ...
  if (param_5 != (char *)0x0) {
    FUN_00403020(&local_130,param_5);
  }
  if (param_4 < 0) {
...
LAB_004043c5:
      ...
      FUN_00403cf0(this,0xf,local_12c,param_6);
    }
  }
  else {
    if (*(char *)((int)this + 0x51) == '\0') goto LAB_004043c5;
    FUN_00403cf0(this,param_1,local_12c,param_6);
  }
  local_8 = 0xffffffff;
  local_130 = CBufferedString<256,0>::vftable;
